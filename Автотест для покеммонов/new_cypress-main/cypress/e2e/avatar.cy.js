describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('GolopopinD@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('941177qqQ');               // вводим пароль
         ...
         cy.get('.card_name').type('Golopopin');                           // вводим имя владельца действия карты
